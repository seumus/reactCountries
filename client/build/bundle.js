...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesRegionSelector = __webpack_require__(162);
	...
	var CountriesBox = React.createClass({
	  ...
	  setRegionCountries: function setRegionCountries(region) {
	    ...
	    try {
	      for (var _iterator = this.state.setCountries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(CountriesRegionSelector, { regions: this.state.regions, setRegionCountries: this.setRegionCountries }),
	      React.createElement(CountriesSelector, { countries: this.state.countries, onSelectCountry: this.setDisplayCountry }),
	      displayElement
	    );
	  }
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        'Capital: ',
	        this.props.display.capital
	      ),
	      React.createElement(
	        'p',
	        null,
	        'Population: ',
	        this.props.display.population
	      ),
	      React.createElement(
	        'h4',
	        { className: 'france' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CountriesRegionSelector = React.createClass({
	  displayName: 'CountriesRegionSelector',
